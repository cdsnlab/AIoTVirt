#!/bin/bash
SDL_HINT_CUDA_DEVICE=1 /home/tung/carla/CARLA_Shipping_0.9.11-dirty/LinuxNoEditor/CarlaUE4.sh -carla-settings=Example.CarlaSettings.ini -windowed -resx=480 -resy=360 -opengl -world-port=2012
