...
class NetClient(TCPReq, CascadeDetector, Logger):
...
faceDetector = NetClient(width=FRAME_WIDTH, descriptor=FACE_DESCR_PATH, method=args.method,
						port=SERVER_PORT, name="Face", log=args.log, display=args.display)
