...
class chamEnv(gym.Env):
    ...
    def step (self, action, count): # input previous reward.
        ...
        self.rew += (self.gpeeweight * gprew) + ((1- self.gpeeweight) * eerew)
        self.qvaluecount[count] = self.rew
        ...
        if count-1 is -1:
            ...
            self.qkey[atmpkeystring+","+action] = self.qkey[atmpkeystring+","+action] + self.alpha * (self.qvaluecount[0] + self.gamma * maxvalue - self.qkey[atmpkeystring+","+action])
            ...
            self.qkey[atmpkeystring+","+action] = self.qkey[atmpkeystring+","+action] + self.alpha * (self.qvaluecount[count] + self.gamma * maxvalue - self.qkey[atmpkeystring+","+action])
            #print("current qvalue: ", self.qkey[atmpkeystring+","+action])
