...
TASK_DATASETS_TEST = ['case1', 'case2', 'case3', 'case4', 'case5', 'case6', 'reside_urhi', 'gtrain', 'ohaze', 'spadata',
                      'realsnow', 'rainds_raindrop', 'rainds_rainstreak', 'rainds_rainstreak_drop']
